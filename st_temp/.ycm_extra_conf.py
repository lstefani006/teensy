...
libDirs = [
        "lib"
        ,PlatformioAutogen
        ,os.path.join(arduino, "hardware/arduino/avr/cores/arduino/")
        ,os.path.join(arduino, "hardware/tools/avr/avr/include/")
        ,os.path.join(arduino, "hardware/tools/avr/avr/include/avr/")
        ,os.path.join(arduino, "hardware/teensy/avr/libraries/SPI/")
        ,os.path.join(arduino, "hardware/teensy/avr/libraries/EEPROM/")
        ,os.path.join(arduino, "hardware/teensy/avr/libraries/TimerOne/")
        ,os.path.join(arduino, "hardware/teensy/avr/libraries/OneWire/")
        ,os.path.join(arduino, "hardware/teensy/avr/libraries/Time/")
        ,"."
        ,"~/teensy/AvrLib/"
        ,"~/teensy/util/"
        ]
