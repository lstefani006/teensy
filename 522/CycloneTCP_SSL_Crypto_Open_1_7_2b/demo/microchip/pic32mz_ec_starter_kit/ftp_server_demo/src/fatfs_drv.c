...
#define CS_SETOUT() TRISBCLR = _TRISB_TRISB14_MASK
#define CS_LOW()  LATBCLR = _LATB_LATB14_MASK	/* MMC CS = L */
#define CS_HIGH() LATBSET = _LATB_LATB14_MASK	/* MMC CS = H */
...
void power_on (void)
{
   ...
   ANSELGCLR = _ANSELG_ANSG6_MASK | _ANSELG_ANSG8_MASK;
