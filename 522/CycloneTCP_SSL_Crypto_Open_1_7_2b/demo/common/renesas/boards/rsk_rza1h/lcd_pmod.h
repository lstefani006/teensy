...
#define ENABLE_PIN                (GPIO.P1)
/* Display enable pin */
#define ENABLE_PIN_BIT            ((uint16_t)0x0020)
#endif

/* Vbat enable pin */
#define VBAT_ENABLE_PIN           (GPIO.PM4)

/* Vbat enable pin */
#define VBAT_ENABLE_PIN_BIT       ((uint16_t)0x8000)

/* Vdd enable pin */
#define BL_ENABLE_PIN             (GPIO.P3)
#define BL_ENABLE_PIN_BIT         ((uint16_t)0x0080)

/* Vdd enable pin */
#define VDD_ENABLE_PIN_BIT        ((uint16_t)0x0080)
