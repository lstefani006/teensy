...
#define DEF_BACKGND_COLOUR 	0x000F0
...
#define PIXEL_CONV(Pixel,Order) (!Order) ? \
	( ((Pixel >> 8) & 0x000000F0) | ((Pixel >> 7) & 0x0000000F) | ((Pixel << 11) & 0x0000F000) ) : \
	( ((Pixel >> 3) & 0x00000F00) | ((Pixel << 13) & 0x00F00000) | ((Pixel << 15) & 0x000F0000) )
