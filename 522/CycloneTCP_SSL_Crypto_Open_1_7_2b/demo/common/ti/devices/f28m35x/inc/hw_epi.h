...
#define EPI_O_BAUD2                0x00000008 // EPI Main Baud2 Rate
...
#define EPI_CFG_INTDIV             0x00000100 // Int Clock Divide Enable
...
#define EPI_HB16CFG_CLKGATEI       0x40000000 // Clock Gated when Idle
...
#define EPI_HB8CFG2_CSCFGEXT       0x08000000 // Chip Select Extended Configuration
...
#define EPI_HB8CFG2_CSCFG_ADCS     0x03000000 // ALE with Dual CSn
                                              // Configuration
#define EPI_HB8CFG2_WRHIGH         0x00200000 // Write Strobe Polarity
#define EPI_HB8CFG2_RDHIGH         0x00100000 // Read Strobe Polarity
#define EPI_HB8CFG2_ALEHIGH        0x00080000 // ALE Strobe Polarity
#define EPI_HB8CFG2_WRWS_M         0x000000C0 // Write Wait States
#define EPI_HB8CFG2_WRWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG2_WRWS_4         0x00000040 // 4 EPI Clocks
#define EPI_HB8CFG2_WRWS_6         0x00000080 // 6 EPI Clocks
#define EPI_HB8CFG2_WRWS_8         0x000000C0 // 8 EPI Clocks
#define EPI_HB8CFG2_RDWS_M         0x00000030 // Read Wait States
#define EPI_HB8CFG2_RDWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG2_RDWS_4         0x00000010 // 4 EPI Clocks
#define EPI_HB8CFG2_RDWS_6         0x00000020 // 6 EPI Clocks
#define EPI_HB8CFG2_RDWS_8         0x00000030 // 8 EPI Clocks
#define EPI_HB8CFG2_MODE_M         0x00000003 // Host Bus Sub-Mode
#define EPI_HB8CFG2_MODE_MUX       0x00000000 // ADMUX - AD[7:0]
#define EPI_HB8CFG2_MODE_NMUX      0x00000001 // ADNONMUX - D[7:0]
#define EPI_HB8CFG2_MODE_SRAM      0x00000002 // Continuous Read - D[7:0]
...
#define EPI_HB16CFG2_CSCFGEXT      0x08000000 // Chip Select Extended Configuration
...
#define EPI_HB16CFG2_CSCFG_ADCS    0x03000000 // ALE with Dual CSn
                                              // Configuration
#define EPI_HB16CFG2_WRHIGH        0x00200000 // Write Strobe Polarity
#define EPI_HB16CFG2_RDHIGH        0x00100000 // Read Strobe Polarity
#define EPI_HB16CFG2_ALEHIGH       0x00080000 // ALE Strobe Polarity
#define EPI_HB16CFG2_BURST         0x00010000 // Burst Mode
#define EPI_HB16CFG2_WRWS_M        0x000000C0 // Write Wait States
#define EPI_HB16CFG2_WRWS_2        0x00000000 // 2 EPI Clocks
#define EPI_HB16CFG2_WRWS_4        0x00000040 // 4 EPI Clocks
#define EPI_HB16CFG2_WRWS_6        0x00000080 // 6 EPI Clocks
#define EPI_HB16CFG2_WRWS_8        0x000000C0 // 8 EPI Clocks
#define EPI_HB16CFG2_RDWS_M        0x00000030 // Read Wait States
#define EPI_HB16CFG2_RDWS_2        0x00000000 // 2 EPI Clocks
#define EPI_HB16CFG2_RDWS_4        0x00000010 // 4 EPI Clocks
#define EPI_HB16CFG2_RDWS_6        0x00000020 // 6 EPI Clocks
#define EPI_HB16CFG2_RDWS_8        0x00000030 // 8 EPI Clocks
#define EPI_HB16CFG2_MODE_M        0x00000003 // Host Bus Sub-Mode
#define EPI_HB16CFG2_MODE_MUX      0x00000000 // ADMUX - AD[7:0]
#define EPI_HB16CFG2_MODE_NMUX     0x00000001 // ADNONMUX - D[7:0]
#define EPI_HB16CFG2_MODE_SRAM     0x00000002 // Continuous Read - D[7:0]
...
#define EPI_ADDRMAP_ECSZ_256B      0x00000000 // 256 bytes; lower address
                                              // range: 0x00 to 0xFF
...
#define EPI_ADDRMAP_ECSZ_256MB     0x00000C00 // 256 MB; lower address range:
                                              // 0x000.0000 to 0xFFF.FFFF
#define EPI_ADDRMAP_ECADR_M        0x00000300 // External Peripheral Address
#define EPI_ADDRMAP_ECADR_NONE     0x00000000 // Not mapped
#define EPI_ADDRMAP_ECADR_A000     0x00000100 // At 0xA000.0000

#define EPI_ADDRMAP_EPSZ_M         0x000000C0 // External Code Size
...
//*****************************************************************************
#define EPI_DMATXCNT_TXCNT         0x0000FFFF // DMA Count
...
//*****************************************************************************
#define EPI_RIS_DMAWRRIS           0x00000010 // Write uDMA Interrupt Status
#define EPI_RIS_DMARDRIS           0x00000008 // Read uDMA Interrupt Status
...
//*****************************************************************************
#define EPI_MIS_DMAWRMIS           0x00000010 // Write uDMA Interrupt Status
#define EPI_MIS_DMARDMIS           0x00000008 // Read uDMA Interrupt Status
...
//*****************************************************************************
#define EPI_HB8CFG3_WRHIGH         0x00200000 // Write Strobe Polarity
#define EPI_HB8CFG3_RDHIGH         0x00100000 // Read Strobe Polarity
#define EPI_HB8CFG3_ALEHIGH        0x00080000 // ALE Strobe Polarity
#define EPI_HB8CFG3_WRWS_M         0x000000C0 // Write Wait States
#define EPI_HB8CFG3_WRWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG3_WRWS_4         0x00000040 // 4 EPI Clocks
#define EPI_HB8CFG3_WRWS_6         0x00000080 // 6 EPI Clocks
#define EPI_HB8CFG3_WRWS_8         0x000000C0 // 8 EPI Clocks
#define EPI_HB8CFG3_RDWS_M         0x00000030 // Read Wait States
#define EPI_HB8CFG3_RDWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG3_RDWS_4         0x00000010 // 4 EPI Clocks
#define EPI_HB8CFG3_RDWS_6         0x00000020 // 6 EPI Clocks
#define EPI_HB8CFG3_RDWS_8         0x00000030 // 8 EPI Clocks
#define EPI_HB8CFG3_MODE_M         0x00000003 // Host Bus Sub-Mode
#define EPI_HB8CFG3_MODE_MUX       0x00000000 // ADMUX - AD[7:0]
#define EPI_HB8CFG3_MODE_NMUX      0x00000001 // ADNONMUX - D[7:0]
#define EPI_HB8CFG3_MODE_SRAM      0x00000002 // Continuous Read - D[7:0]
#define EPI_HB8CFG3_MODE_RSVD      0x00000003 // Reserved

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB16CFG3 register.
//*****************************************************************************
#define EPI_HB16CFG3_WRHIGH        0x00200000 // Write Strobe Polarity
#define EPI_HB16CFG3_RDHIGH        0x00100000 // Read Strobe Polarity
#define EPI_HB16CFG3_ALEHIGH       0x00080000 // ALE Strobe Polarity
#define EPI_HB16CFG3_BURST         0x00010000 // Burst Mode
#define EPI_HB16CFG3_WRWS_M        0x000000C0 // Write Wait States
#define EPI_HB16CFG3_WRWS_2        0x00000000 // 2 EPI Clocks
#define EPI_HB16CFG3_WRWS_4        0x00000040 // 4 EPI Clocks
#define EPI_HB16CFG3_WRWS_6        0x00000080 // 6 EPI Clocks
#define EPI_HB16CFG3_WRWS_8        0x000000C0 // 8 EPI Clocks
#define EPI_HB16CFG3_MODE_M        0x00000003 // Host Bus Sub-Mode
#define EPI_HB16CFG3_MODE_MUX      0x00000000 // ADMUX - AD[7:0]
#define EPI_HB16CFG3_MODE_NMUX     0x00000001 // ADNONMUX - D[7:0]
#define EPI_HB16CFG3_MODE_SRAM     0x00000002 // Continuous Read - D[7:0]
#define EPI_HB16CFG3_MODE_RSVD     0x00000003 // Reserved

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB8CFG4 register.
//*****************************************************************************
#define EPI_HB8CFG4_WRHIGH         0x00200000 // Write Strobe Polarity
#define EPI_HB8CFG4_RDHIGH         0x00100000 // Read Strobe Polarity
#define EPI_HB8CFG4_ALEHIGH        0x00080000 // ALE Strobe Polarity
#define EPI_HB8CFG4_WRWS_M         0x000000C0 // Write Wait States
#define EPI_HB8CFG4_WRWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG4_WRWS_4         0x00000040 // 4 EPI Clocks
#define EPI_HB8CFG4_WRWS_6         0x00000080 // 6 EPI Clocks
#define EPI_HB8CFG4_WRWS_8         0x000000C0 // 8 EPI Clocks
#define EPI_HB8CFG4_RDWS_M         0x00000030 // Read Wait States
#define EPI_HB8CFG4_RDWS_2         0x00000000 // 2 EPI Clocks
#define EPI_HB8CFG4_RDWS_4         0x00000010 // 4 EPI Clocks
#define EPI_HB8CFG4_RDWS_6         0x00000020 // 6 EPI Clocks
#define EPI_HB8CFG4_RDWS_8         0x00000030 // 8 EPI Clocks
#define EPI_HB8CFG4_MODE_M         0x00000003 // Host Bus Sub-Mode
#define EPI_HB8CFG4_MODE_MUX       0x00000000 // ADMUX - AD[7:0]
#define EPI_HB8CFG4_MODE_NMUX      0x00000001 // ADNONMUX - D[7:0]
#define EPI_HB8CFG4_MODE_SRAM      0x00000002 // Continuous Read - D[7:0]
#define EPI_HB8CFG4_MODE_RSVD      0x00000003 // Reserved
...
//*****************************************************************************
#define EPI_HB8TIME_IRDYDLY_M      0x03000000 // Input Ready Delay Mask
#define EPI_HB8TIME_IRDYDLY_1      0x01000000 // 1 EPI Clocks
#define EPI_HB8TIME_IRDYDLY_2      0x02000000 // 2 EPI Clocks
#define EPI_HB8TIME_IRDYDLY_3      0x03000000 // 3 EPI Clocks
#define EPI_HB8TIME_CAPWIDTH_M     0x00003000 // Inter-transfer Capture Width
#define EPI_HB8TIME_CAPWIDTH_M     0x00001000 // 1 EPI Clocks
#define EPI_HB8TIME_CAPWIDTH_M     0x00002000 // 2 EPI Clocks
#define EPI_HB8TIME_WRWSM          0x00000010 // Write Wait State Minus 1
#define EPI_HB8TIME_RDWSM          0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB16TIME register.
//*****************************************************************************
#define EPI_HB16TIME_IRDYDLY_M     0x03000000 // Input Ready Delay Mask
#define EPI_HB16TIME_IRDYDLY_1     0x01000000 // 1 EPI Clocks
#define EPI_HB16TIME_IRDYDLY_2     0x02000000 // 2 EPI Clocks
#define EPI_HB16TIME_IRDYDLY_3     0x03000000 // 3 EPI Clocks
#define EPI_HB16TIME_CAPWIDTH_M    0x00003000 // Inter-transfer Capture Width
#define EPI_HB16TIME_CAPWIDTH_M    0x00001000 // 1 EPI Clocks
#define EPI_HB16TIME_CAPWIDTH_M    0x00002000 // 2 EPI Clocks
#define EPI_HB16TIME_WRWSM         0x00000010 // Write Wait State Minus 1
#define EPI_HB16TIME_RDWSM         0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB8TIME2 register.
//*****************************************************************************
#define EPI_HB8TIME2_IRDYDLY_M     0x03000000 // Input Ready Delay Mask
#define EPI_HB8TIME2_IRDYDLY_1     0x01000000 // 1 EPI Clocks
#define EPI_HB8TIME2_IRDYDLY_2     0x02000000 // 2 EPI Clocks
#define EPI_HB8TIME2_IRDYDLY_3     0x03000000 // 3 EPI Clocks
#define EPI_HB8TIME2_CAPWIDTH_M    0x00003000 // Inter-transfer Capture Width
#define EPI_HB8TIME2_CAPWIDTH_M    0x00001000 // 1 EPI Clocks
#define EPI_HB8TIME2_CAPWIDTH_M    0x00002000 // 2 EPI Clocks
#define EPI_HB8TIME2_WRWSM         0x00000010 // Write Wait State Minus 1
#define EPI_HB8TIME2_RDWSM         0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB16TIME2 register.
//*****************************************************************************
#define EPI_HB16TIME2_IRDYDLY_M    0x03000000 // Input Ready Delay Mask
#define EPI_HB16TIME2_IRDYDLY_1    0x01000000 // 1 EPI Clocks
#define EPI_HB16TIME2_IRDYDLY_2    0x02000000 // 2 EPI Clocks
#define EPI_HB16TIME2_IRDYDLY_3    0x03000000 // 3 EPI Clocks
#define EPI_HB16TIME2_CAPWIDTH_M   0x00003000 // Inter-transfer Capture Width
#define EPI_HB16TIME2_CAPWIDTH_M   0x00001000 // 1 EPI Clocks
#define EPI_HB16TIME2_CAPWIDTH_M   0x00002000 // 2 EPI Clocks
#define EPI_HB16TIME2_WRWSM        0x00000010 // Write Wait State Minus 1
#define EPI_HB16TIME2_RDWSM        0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB8TIME3 register.
//*****************************************************************************
#define EPI_HB8TIME3_IRDYDLY_M     0x03000000 // Input Ready Delay Mask
#define EPI_HB8TIME3_IRDYDLY_1     0x01000000 // 1 EPI Clocks
#define EPI_HB8TIME3_IRDYDLY_2     0x02000000 // 2 EPI Clocks
#define EPI_HB8TIME3_IRDYDLY_3     0x03000000 // 3 EPI Clocks
#define EPI_HB8TIME3_CAPWIDTH_M    0x00003000 // Inter-transfer Capture Width
#define EPI_HB8TIME3_CAPWIDTH_M    0x00001000 // 1 EPI Clocks
#define EPI_HB8TIME3_CAPWIDTH_M    0x00002000 // 2 EPI Clocks
#define EPI_HB8TIME3_WRWSM         0x00000010 // Write Wait State Minus 1
#define EPI_HB8TIME3_RDWSM         0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB16TIME3 register.
//*****************************************************************************
#define EPI_HB16TIME3_IRDYDLY_M    0x03000000 // Input Ready Delay Mask
#define EPI_HB16TIME3_IRDYDLY_1    0x01000000 // 1 EPI Clocks
#define EPI_HB16TIME3_IRDYDLY_2    0x02000000 // 2 EPI Clocks
#define EPI_HB16TIME3_IRDYDLY_3    0x03000000 // 3 EPI Clocks
#define EPI_HB16TIME3_CAPWIDTH_M   0x00003000 // Inter-transfer Capture Width
#define EPI_HB16TIME3_CAPWIDTH_M   0x00001000 // 1 EPI Clocks
#define EPI_HB16TIME3_CAPWIDTH_M   0x00002000 // 2 EPI Clocks
#define EPI_HB16TIME3_WRWSM        0x00000010 // Write Wait State Minus 1
#define EPI_HB16TIME3_RDWSM        0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB8TIME4 register.
//*****************************************************************************
#define EPI_HB8TIME4_IRDYDLY_M     0x03000000 // Input Ready Delay Mask
#define EPI_HB8TIME4_IRDYDLY_1     0x01000000 // 1 EPI Clocks
#define EPI_HB8TIME4_IRDYDLY_2     0x02000000 // 2 EPI Clocks
#define EPI_HB8TIME4_IRDYDLY_3     0x03000000 // 3 EPI Clocks
#define EPI_HB8TIME4_CAPWIDTH_M    0x00003000 // Inter-transfer Capture Width
#define EPI_HB8TIME4_CAPWIDTH_M    0x00001000 // 1 EPI Clocks
#define EPI_HB8TIME4_CAPWIDTH_M    0x00002000 // 2 EPI Clocks
#define EPI_HB8TIME4_WRWSM         0x00000010 // Write Wait State Minus 1
#define EPI_HB8TIME4_RDWSM         0x00000001 // Read Wait State Minus 1

//*****************************************************************************
// The following are defines for the bit fields in the EPI_O_HB16TIME4 register.
//*****************************************************************************
#define EPI_HB16TIME4_IRDYDLY_M    0x03000000 // Input Ready Delay Mask
#define EPI_HB16TIME4_IRDYDLY_1    0x01000000 // 1 EPI Clocks
#define EPI_HB16TIME4_IRDYDLY_2    0x02000000 // 2 EPI Clocks
#define EPI_HB16TIME4_IRDYDLY_3    0x03000000 // 3 EPI Clocks
#define EPI_HB16TIME4_CAPWIDTH_M   0x00003000 // Inter-transfer Capture Width
#define EPI_HB16TIME4_CAPWIDTH_M   0x00001000 // 1 EPI Clocks
#define EPI_HB16TIME4_CAPWIDTH_M   0x00002000 // 2 EPI Clocks
#define EPI_HB16TIME4_WRWSM        0x00000010 // Write Wait State Minus 1
#define EPI_HB16TIME4_RDWSM        0x00000001 // Read Wait State Minus 1
