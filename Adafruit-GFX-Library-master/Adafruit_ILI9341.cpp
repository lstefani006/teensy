...
void Adafruit_ILI9341::setAddrWindow2(uint16_t x0, uint16_t y0, uint16_t x1,
		uint16_t y1) {
...
// fill a rectangle
void Adafruit_ILI9341::drawImg(int16_t x, int16_t y, int16_t w, int16_t h, const uint16_t *img) {
